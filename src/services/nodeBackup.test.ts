...
const memo: Node = { id: 'm', type: 'memo', parentId: 'c', sortKey: 'a0', title: 'Memo', body: 'body', dueAt: date, duePreset: 'custom', status: 'active', completedAt: null, createdAt: date, updatedAt: date, deletedAt: null, deletionBatchId: 'metadata' };
