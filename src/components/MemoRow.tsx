...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  selectedNote: { borderColor: colors.accent, backgroundColor: colors.accentSoft }, checkbox: { width: 22, height: 22, marginLeft: 9, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.border, borderRadius: 4, backgroundColor: colors.surface }, checkboxOn: { borderColor: colors.accent, backgroundColor: colors.accent }, checkmark: { color: colors.background, fontWeight: '800' },
