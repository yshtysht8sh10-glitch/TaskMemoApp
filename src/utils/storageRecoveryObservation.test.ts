...
it("exports only validated recovery metadata, never injected IDs or private strings", () => {
  ...
  const stored = JSON.stringify({ recoveryPhase: "receipt-batch-start", receiptComparisonTotal: 1024,
    ...
    execution: { startedAt: '2026-09-26T07:00:00.000Z', endedAt: '2026-09-26T07:00:20.000Z',
      status: 'failed', totalOperations: 1024, uploadAttemptedCount: 465,
      uploadSucceededCount: 464, uploadFailedCount: 1, uploadSupersededCount: 300,
      lastCompletedOperationIndex: 463, currentOperationIndex: 464,
      lastSuccessfulOperationIndex: 463, elapsedMs: 20000,
      currentPhase: 'upload', lastCompletedPhase: 'pre-execution-receipt-audit',
      failurePhase: 'upload', failedOperationIndex: 464, failedOperationType: 'update',
      errorCode: 'invalid-argument', errorMessage: 'The transaction winner differs from the preflight prediction.',
      failureReason: 'predicted-winner-mismatch', preExecutionReceiptReceivedCount: 0,
      preExecutionReceiptMissingCount: 1024, postExecutionReceiptReceivedCount: 464,
      postExecutionReceiptMissingCount: 560, postExecutionReceiptAuditCompleted: true,
      transactionStartedCount: 465, transactionSucceededCount: 464, transactionFailedCount: 1,
      receiptExistingCount: 0, receiptCreatedCount: 464, nodeWriteCount: 200,
      serverWinnerNoWriteCount: 264, opId: 'SECRET_OP', title: 'SECRET_TITLE',
      arbitraryMessage: 'private@example.com' },
  ...
  expect(output.recoveryObservation.execution).toMatchObject({ status: 'failed', totalOperations: 1024,
    ...
    failureReason: 'predicted-winner-mismatch', postExecutionReceiptReceivedCount: 464,
    postExecutionReceiptMissingCount: 560, postExecutionReceiptAuditCompleted: true,
    transactionStartedCount: 465, transactionSucceededCount: 464, transactionFailedCount: 1 });
