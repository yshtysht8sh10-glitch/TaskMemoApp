...
it("exports allowlisted collision provenance but never titles, bodies, or unrelated private strings", () => {
  ...
  const stored = JSON.stringify({ recoveryPhase: "receipt-batch-start", receiptComparisonTotal: 1024,
    ...
    preflight: { remoteNodeCount: 150, journalNodeCount: 151, journalOnlyNodeCount: 1,
      ...
      finalPreflight: { candidateNodeCount: 151, finalRecoverySafetyDecision: 'blocked',
        sortKeyRepairPreview: { changedNodeCount: 9, plannedOperationCount: 9, planValid: true,
          structureBefore: { nodeCount: 152, duplicateActiveSortKeyNodeCount: 18,
            duplicateActiveSortKeyGroupCount: 9, valid: false },
          structureAfter: { nodeCount: 152,
          duplicateActiveSortKeyNodeCount: 0, duplicateActiveSortKeyGroupCount: 0, valid: true },
          candidateOnlyNodeCount: 1, journalOnlyNodeCount: 0,
          nonSortKeyValueDifferenceNodeCount: 0, nonSortKeyExactDifferenceNodeCount: 38,
          syncMetadataDifferenceNodeCount: 38,
          unknownFieldDifferenceNodeCount: 0, receiptAuditBlockCount: 1,
          otherSafetyBlockCount: 0, requiresAdditionalOperations: true,
          title: 'SECRET_TITLE' },
  ...
  expect(output.recoveryObservation.preflight).toMatchObject({
    ...
    finalPreflight: { candidateNodeCount: 151, finalRecoverySafetyDecision: 'blocked',
      sortKeyRepairPreview: { changedNodeCount: 9, plannedOperationCount: 9, planValid: true,
        structureBefore: { duplicateActiveSortKeyGroupCount: 9, valid: false },
        structureAfter: {
        duplicateActiveSortKeyNodeCount: 0, duplicateActiveSortKeyGroupCount: 0, valid: true },
        candidateOnlyNodeCount: 1, syncMetadataDifferenceNodeCount: 38,
        requiresAdditionalOperations: true },
