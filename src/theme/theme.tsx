...
export const THEME_COLORS: Record<"light" | "dark", ThemeColors> = {
  light: {
    ...
    accent: "#40566c",
    accentSoft: "#edf4f3",
    memoBackground: "#fff7d6",
    memoBorder: "#e3d6a5",
    memoText: "#34372f",
    ideaBackground: "#eaf7ec",
    ideaBorder: "#9bc6a3",
    ideaText: "#244b2d",
    completedBackground: "#eef0f1",
    danger: "#b63838",
    guide: "#9ca6b1",
    backdrop: "rgba(20,25,30,.35)",
    snackbarBackground: "#222b36",
    snackbarText: "#ffffff",
    snackbarAction: "#b9dbf4",
  },
  dark: {
    background: "#11151a",
    surface: "#1b2128",
    surfaceAlt: "#29313a",
    text: "#edf1f5",
    textSecondary: "#aeb8c3",
    border: "#3a444f",
    accent: "#8fb5d1",
    accentSoft: "#243b3b",
    memoBackground: "#373323",
    memoBorder: "#655d3d",
    memoText: "#f1ead0",
    ideaBackground: "#20372a",
    ideaBorder: "#4f765b",
    ideaText: "#d5efda",
    completedBackground: "#292e33",
    danger: "#ff8585",
    guide: "#687582",
    backdrop: "rgba(0,0,0,.62)",
    snackbarBackground: "#e5edf4",
    snackbarText: "#17202a",
    snackbarAction: "#315976",
  },
};
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo(
    () => ({ mode, resolved, colors: THEME_COLORS[resolved], setMode }),
    [mode, resolved],
  );
  return (
