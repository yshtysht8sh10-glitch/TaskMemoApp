...
const manifest = { schemaVersion: 1, builtAt: new Date().toISOString(), environment: "production", firebaseProjectId: "taskmemoapp-eabc3", syncV2Enabled: true, releaseChannel: "production-v2-cutover", commit: execFileSync("git", ["rev-parse", "HEAD"], { encoding: "utf8" }).trim(), artifactPath: "dist", canonicalArtifactSha256: artifactHash.digest("hex") };
