...
const env = { ...process.env, ...parsed, TASKMEMO_ENV_FILE: environmentFile, EXPO_PUBLIC_BUILD_SHA: commit, EXPO_PUBLIC_TASKMEMO_ENV: "production", EXPO_PUBLIC_SYNC_V2_ENABLED: "true", EXPO_PUBLIC_RELEASE_CHANNEL: "production-v2-cutover" };
...
const manifest = { schemaVersion: 1, builtAt: new Date().toISOString(), environment: "production", firebaseProjectId: "taskmemoapp-eabc3", syncV2Enabled: true, releaseChannel: "production-v2-cutover", commit, artifactPath: "dist", canonicalArtifactSha256: artifactHash.digest("hex") };
