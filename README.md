...
2026-09-20受領分は、ユーザー承認により`ipa-morning`だけを別の修復コピーから除外し、修復版124 Node全体を正データとして確定しました。formal Emulator rehearsalは124→124、semantic/lost field 0でPASSしています。production cutoverは別途明示承認されるまで実行しません。
